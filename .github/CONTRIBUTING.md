...
If you come across any bugs or something that doesn't seem right, please [open an issue](https://github.com/codiume/termwind/issues). Also, if you have an idea for the project, open an issue to start the discussion.
